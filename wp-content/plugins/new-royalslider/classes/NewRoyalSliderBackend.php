...
class NewRoyalSliderBackend {
	...
	function ajax_get_slider_markup() {
	    ...
	    echo  NewRoyalSliderGenerator::generateSlides(true, '', $_POST['slider_type'], $markup, $slides, $options, stripslashes_deep($_POST['template']), $_POST['skin']);
    ...
    function register_scripts() {
    	wp_register_script( 'rs-textchange', NEW_ROYALSLIDER_PLUGIN_URL . "lib/backend/jquery.textchange.js", array('jquery'), NEW_ROYALSLIDER_WP_VERSION, 'all');
    	...
    	wp_register_script( 'jquery-rs-qtip', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/custom/jquery.qtip.min.js', array('jquery'), NEW_ROYALSLIDER_WP_VERSION, 'all');
    	wp_register_script( 'jquery-html5-sortable', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/jquery.sortable.js', array('jquery'), NEW_ROYALSLIDER_WP_VERSION, 'all');
    	...
    	wp_register_script( 'new-royalslider-backend', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/royalslider-admin.js', array('jquery', 'jquery-ui-widget', 'jquery-ui-core', 'jquery-ui-dialog'), NEW_ROYALSLIDER_WP_VERSION, 'all');
		...
		wp_register_script( 'new-royalslider-blockeditor', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/royalslider-block-editor.js', array('jquery'));
		...
		wp_register_script( 'new-royalslider-video-tab', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/royalslider-video-tab.js', array('jquery'));
		wp_register_script( 'new-royalslider-preview-slider', NEW_ROYALSLIDER_PLUGIN_URL . 'lib/backend/royalslider-preview.js', array('jquery'));
	    ...
	    $fields = array(
	        'new_royalslider_config' => array(
	            ...
	            array(
	                ...
	                'label' => __( 'Override all default WordPress galleries in posts (without adding <code>royalslider</code> attribute to <code>[gallery]</code> shortcode)<br/>You can still add this attribute to your galleries if you want to override default.', 'new_royalslider' ),
